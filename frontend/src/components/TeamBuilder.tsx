...
export const TeamBuilder: FC<TeamBuilderProps> = ({
    ...
    return mobile ? (
        <Stack alignItems={'center'} flex={1} spacing={1} width={'100%'}>
            <Market
                manager={manager}
                market={market}
            ...
            <Stack alignItems={'center'} flex={1} spacing={2} width={'100%'}>
                ...
                <Stack alignItems={'center'} width={'100%'}>
                    {round < 39 ? (
                        <Button
                            ...
                            disabled={
                                !captain ||
                                Object.values(team).reduce((acc, curr) => acc + curr.length, 0) !=
                                    12
                            }
                        >
